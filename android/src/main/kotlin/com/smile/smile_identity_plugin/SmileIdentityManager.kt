...
class SmileIdentityManager {
    ...
    private fun captureSelfie(tag: String, captureType: CaptureType) {
        try {
            ...
            val builder =
                SIDCaptureManager.Builder(activity, captureType, 1000 + captureType.ordinal)
            builder.setTag(tag)
